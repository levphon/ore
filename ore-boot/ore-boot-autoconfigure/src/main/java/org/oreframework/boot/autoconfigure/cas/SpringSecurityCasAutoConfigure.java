...
/**
 * 注意:本类使用spring-security-cas包自带的 cas-client-new-3.4.1版本
...
@ConditionalOnProperty(prefix = "ore.cas", name = "server-url")
public class SpringSecurityCasAutoConfigure extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()// 配置安全策略
				...
				// .antMatchers("/","/**/*.{js,html}").permitAll()//定义/请求不需要验证
	...
	public SingleSignOutFilter singleSignOutFilter() {
		...
		//cas-client-new-3.4.1版本才有.setCasServerUrlPrefix();方法
