...
import org.oreframework.boot.autoconfigure.condition.DataSourceMultiTypeCondition;
...
import org.oreframework.boot.autoconfigure.datasource.mybatis.MybatisProperties;
...
@Conditional(DataSourceMultiTypeCondition.class)
@ConditionalOnClass({ DataSourceMultiTypeCondition.class, SqlSessionFactory.class, SqlSessionFactoryBean.class })
@ConditionalOnBean({ DataSource.class, DruidAutoConfiguration.class })
...
public class MybatisAutoConfiguration {
	...
	public MybatisAutoConfiguration(@Qualifier(BeanNameConstants.PRIMARY_MYBATISPROPERTIES) MybatisProperties properties,
	...
	public static class AutoConfiguredMapperScannerRegistrar
		...
		public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata,
			...
			try {
				...
				scanner.setSqlSessionFactoryBeanName(BeanNameConstants.PRIMARY_SQLSESSIONFACTORY);
				scanner.setSqlSessionTemplateBeanName(BeanNameConstants.PRIMARY_SQLSESSIONTEMPLATE);
				// scanner.doScan(StringUtils.toStringArray(packages));
				scanner.doScan("org.oreframework.boot.sample.web.biz.sample.datasource.multi.primary");

				ClassPathMapperScanner scannerSecondary = new ClassPathMapperScanner(registry);
				scannerSecondary.registerFilters();
				scannerSecondary.setSqlSessionFactoryBeanName(BeanNameConstants.SECONDARY_SQLSESSIONFACTORY);
				scannerSecondary.setSqlSessionTemplateBeanName(BeanNameConstants.SECONDARY_SQLSESSIONTEMPLATE);
				scannerSecondary.doScan("org.oreframework.boot.sample.web.biz.sample.datasource.multi.secondary");
